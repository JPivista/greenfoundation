    ...
    return (
        <>
            <Container className='py-5 text-center'>
                ...
                <Image src='/our-work/agrobio/agrobiodiversity_v.png' alt='' width="80%" />
            </Container>

            <Container fluid style={{ background: '#E4E4E4' }} >
                <Container className='py-3 p-0'>
                    <h3 className=' text-green text-center'>Preserve the Ecology</h3>
                    <Row>
                        <Col>
                            <Image src='/our-work/agrobio/prevence_hand.svg' alt='' />
                    ...
                    <div className='community-row'>
                        <Row className='community-scroll d-flex flex-column flex-wrap flex-md-row p-2'>
                            <Col className='community-seed-bank' >
                                ...
                                <p className='community-para'>There are currently three CSBs in Kanakapura Taluk which combinedly has 142 varieties of Ragi and minor millet, 78 varieties of Paddy, 19 varieties of vegetables, 7 varieties of pulses and 9 varieties of oilseeds.
                                </p>
                            </Col>
                            <Col className='community-seed-bank'>
                                <Image src='/our-work/agrobio/community_seed_banks_icon_slider.svg' alt='' />
                                <p className='community-para'>Through collaboration with 11 other NGOs, GREEN has also initiated the setting up of 34 seed banks in 9 of Karnataka’s 10 agro-climatic zones. These seed banks formed a Community Seed Bank Network (CSBN) developed to address the dire need for agrobiodiversity conservation in Karnataka.
                                </p>
                            </Col>
                            <Col className='community-seed-bank'>
                                <Image src='/our-work/agrobio/rupee_slider.svg' alt='' />
                                <p className='community-para'>GREEN’s pioneering efforts at biodiversity has galvanized whole communities to spread its message of sustainability. The effectiveness of these seed banks has influenced the Karnataka Govt. to fund the establishment of CSBs throughout the state.
                                </p>
                            </Col>
                            <Col className='community-seed-bank'>
                                <Image src='/our-work/agrobio/slider_icon_1.svg' alt='' />
                                <p className='community-para'>GREEN started its CSB in Pudukkottai at Tamil Nadu and Kalaburigi in Karnataka. Both the places Women farmers saving their indigenous varieties of Millets, Paddy, oil seeds, vegetable seeds, and pulses.
                                </p>
                            </Col>
                            <Col className='community-seed-bank'>
                                <Image src='/our-work/agrobio/slider_icon_2.svg' alt='' />
                                <p className='community-para'>CSBs have proved to be more than just seed repositories. They have provided a platform for community members to set up alternate income generating schemes. The information sharing that often takes place at seed bank meetings raises awareness of sustainable agriculture within a community. Through these meetings, many more farmers are persuaded to adopt organic farming practices.
                                </p>
                            </Col>
                        </Row>
                    </div>
