            ...
            <Container className='py-5 p-0'>
                ...
                <Row className='p-0 '>
                    <Col md={8} className='d-flex flex-column gap-2'>
                        ...
                        <Col md={7}>
                            <Image src='/publications/news-and-events/rare-varity-visit/rare_variety_demonstration_2.jpg' alt='' fluid />
                        </Col>
                        <p>The modern agricultural trend enhanced the erosion of agro biodiversity resulting in loss of valuable traditional crops and varietal local indigenous seeds.Conserving the diverse indigenous crop varieties has been an ongoing program by GREEN Foundation. The prime objective of the rare variety demonstrations is to make the community aware of the diversity they possessed and compare the performances of each variety with the existing locally cultivated strains. These demo plots not only showcase the varietal richness, but also used as a platform for farmers to evaluate these varieties with respect to pest resistance, yield and fodder qualities.</p>
                        ...
                        <Col md={7}>
                            <Image src='/publications/news-and-events/rare-varity-visit/rare_variety_demonstration_3.jpg' alt='' fluid />
                        </Col>
