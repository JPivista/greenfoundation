            ...
            <Container className='py-5 p-0'>
                ...
                <Row className='p-0 '>
                    <Col md={8} className='d-flex flex-column gap-2'>
                        ...
                        <Col md={7}>
                            <Image src='/publications/news-and-events/urban-krishi/krishi_mela_2014_1.jpeg' alt='' fluid />
                        </Col>
                        <p>
                        ...
                        <Col md={7}>
                            <Image src='/publications/news-and-events/urban-krishi/krishi_mela_2014_2.jpg' alt='' fluid />
                        </Col>
                        <p>
