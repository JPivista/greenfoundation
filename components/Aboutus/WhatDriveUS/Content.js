                ...
                <Container>
                    ...
                    <Row className='yellow-lime-green-bg custom-drive-row'>
                        ...
                        <Col className='p-md-4 p-2 text-white'>
                            <p>“We realized there was something wrong with this method of agriculture when the fertility of the soil began diminishing,” says Vijayamma, a farmer in Tamil Nadu, of the chemical farming methods her family used to practise until they were introduced to GREEN. For small scale and marginal farmers like Vijayamma, this was particularly worrying, because land is their lifeline to food security.</p>

                            <p>“In spite of getting reduced yields the costs of cultivation had remained the same. But we did not know where to turn for help,” she adds.</p>

                            <p>With a large part of India’s land (nearly 49%) utilized in agriculture, unsustainable agricultural practices can lead to untold consequences for the country’s ecology. For example, it has been shown that a single acre of chemically grown sugarcane requires as much water as would suffice for 25 acres of indigenous variety maize (a crop which also enriches a farming household’s nutrient intake).</p>

                            <p>In light of facts such as these, it becomes clear the extensive change that can be brought about for India’s ecology through correct agricultural</p>
                        </Col>
                    </Row>
                </Container>
            </Container>
